...
config = {
    ...
    "cities" : [
        ...
        'Modena', 'Parma', 'Perugia', 'Livorno', 'Ravenna', 'Foggia', 'Rimini', 'Salerno', 'Ferrara', 'Sassari', 
#       'Latina', 'Giugliano in Campania', 'Monza', 'Syracuse', 'Bergamo', 'Pescara', 'Forlì', 'Trento', 'Vicenza', 'Terni', 'Bolzano', 'Novara',
